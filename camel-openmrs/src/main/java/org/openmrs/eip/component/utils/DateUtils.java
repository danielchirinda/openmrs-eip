...
public final class DateUtils {
    ...
    /**
     * Checks the dates in the first collection argument to those in the second to determine the collection containing the latest date, null being considered to be the earliest value.
     *
