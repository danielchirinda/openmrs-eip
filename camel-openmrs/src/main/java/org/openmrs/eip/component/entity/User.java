...
@AttributeOverride(name = "name", column = @Column(name = "retire_reason", insertable = false, updatable = false))
@AttributeOverride(name = "description", column = @Column(name = "secret_question", insertable = false, updatable = false))
